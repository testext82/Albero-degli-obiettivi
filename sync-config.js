/* ============================================================
   ...
   Come ottenere la chiave (gratis, ~3 minuti):
     ...
     4. Nella scheda "Permissions" attiva queste TRE voci e premi Submit:
          ...
          files.content.read
          files.content.write
        Nota: "account_info.read" resta spuntato perche' Dropbox lo impone
        a livello di registrazione, ma l'app NON lo richiede in fase di
        autorizzazione, quindi non ottiene accesso al tuo account.
        Togli invece "account_info.write" se risulta attivo.
        (se cambi i permessi dopo esserti collegato, devi scollegare
         e ricollegare l'app: sono legati all'autorizzazione)
...
window.ALBERO_SYNC = {
  dropboxAppKey: ""   // es. "a1b2c3d4e5f6g7h"
};
