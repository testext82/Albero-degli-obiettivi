...
**5. Accedi.** Apri l'app, premi **Sincronizza** e scegli *Ricevi link di accesso*
(basta l'email, nessuna password) oppure *Accedi con GitHub* — quest'ultimo richiede di
abilitare il provider GitHub in *Authentication → Providers*.
